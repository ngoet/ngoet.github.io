...
var tip = d3.tip()
  ...
  .offset([-10, 0])
  .html(function(d) {
  return "<strong>Difficulty:</strong> <span style='color:orange'>" + Math.round(d.Difficulty * 100) / 100 + "</span>";
  });
  ...
  svg.selectAll(".bar")
    ...
    .enter().append("rect")
      ...
      .attr("y", function(d) {
          ...
          if (d.Difficulty > 0){
              return Math.abs(y(d.Difficulty));
          } else {
              return Math.abs(y(0));
          }
      ...
      .attr("width", x.rangeBand())
        .attr("height", function(d) {
          if (d.Difficulty > 0){
            return Math.abs(y(0)-y(d.Difficulty));
            } else {
              return Math.abs(y(0)-y(d.Difficulty));
          }
        })
...
//sorting values
  ...
  function change() {
    ...
    var x0 = x.domain(data.sort(this.checked
        ? function(a, b) { return b.Difficulty - a.Difficulty; }
